        ...
        <div className="p-4 rounded-2xl bg-slate-950/70 backdrop-blur-md border border-slate-800">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-900/50 border border-slate-800/80">
              ...
              <div className="text-sm font-extrabold text-white uppercase tracking-wider font-mono">EXPLORE</div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-900/50 border border-slate-800/80">
              ...
              <div className="text-sm font-extrabold text-white uppercase tracking-wider font-mono">INNOVATE</div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-900/50 border border-slate-800/80">
              ...
              <div className="text-sm font-extrabold text-white uppercase tracking-wider font-mono">TRANSFORM</div>
            </div>
